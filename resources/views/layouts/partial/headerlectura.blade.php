    ...
    <div class="menu">
        ...
        <div class="menu-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end me-lg-3">
                <a class="dropdown-item d-flex align-items-center" href="#">Editar Perfil <i class="fa fa-user-circle fa-fw ms-auto text-gray-400 fs-16px"></i></a>
                <a class="dropdown-item d-flex align-items-center" href="/principal">Inicio<i class="fa fa-user-circle fa-fw ms-auto text-gray-400 fs-16px"></i></a>
