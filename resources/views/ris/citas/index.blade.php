...
@extends('layouts.plantillaAsignarcitas', [
  'appTopNav' => true,
  'appClass' => 'app app-content-full-width'
])


@section('title','Asignar citas')
@section('tituloformulario','Asignar citas')
...
<script src="/assets/js/plugins/datepicker/js/bootstrap-datepicker.min.js"></script>
