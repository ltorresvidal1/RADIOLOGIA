...
<div class="ms-auto">
    <a href="{{route('rissalas.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle fa-fw me-1"></i> Crear salas</a>
</div>
@endsection
@section('tituloformulario','Salas')
@section('principalformulario','SALAS')
@section('accionformulario','TODOS')
@section('descripcionformulario','Listado de salas creadas')
            ...
            <td>
                ...
                <div class="dropdown text-center">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="{{ route('rissalas.edit', $sala->id) }}" class="dropdown-item"><i class="far fa-edit fa-fw fa-lg"></i> Editar</a>
                        <form id="delete-{{$sala->id}}" action="{{route('rissalas.destroy',$sala)}}" method="POST">
                            @csrf
                            @method('DELETE')
                        </form>
                        <a href="#" class="dropdown-item"  onclick="EliminarSala('{{ $sala->id }}')"><i class="far fa-trash-alt fa-fw fa-lg"></i> Eliminar</a>
                    </div>
                </div>
